...
import com.piusxi.admin.backend.showStudents;
...
public class allStudents extends JFrame {
    ...
    public allStudents() {
        ...
        // Title at the top
        titleLabel = new JLabel("All Students", JLabel.CENTER);
    ...
    private void loadStudentData() {
        ...
        if (connection != null) {
            studentData = showStudents.getStudentInfo(connection);
            serviceData = showStudents.getStudentService(connection);
            
            // Sort the data by last name, then first name
            Arrays.sort(studentData, new Comparator<Object[]>() {
                @Override
