...
public class allSeniors extends JFrame {
    ...
    private Object[][] seniorData;
    private Object[][] serviceData;
    private JLabel titleLabel;
    private JLabel selectedStudentLabel;
    
    public allSeniors() {
        setTitle("Seniors Students");
        setSize(1000, 700);
        ...
        // Title at the top
        titleLabel = new JLabel("Seniors Students", JLabel.CENTER);
    ...
    private void loadSeniorData() {
        ...
        if (connection != null) {
            seniorData = showSeniors.getSeniorInfo(connection);
            serviceData = showSeniors.getSeniorService(connection);
            
            // Sort the data by last name, then first name
            Arrays.sort(seniorData, new Comparator<Object[]>() {
                @Override
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            allSeniors frame = new allSeniors();
